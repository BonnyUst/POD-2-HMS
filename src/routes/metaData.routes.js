...
const {getMyMenus} = require('../controllers/meta.controller')
const router = createRouter();
const {getMenuByRole,createMenu,assignMenuToRole,updateMenu,toggleMenu,deleteMenu}=require('../controllers/meta.controller')

router.post('/menu', auth, authorize("*"), createMenu);
router.post('/menu/assign', auth, authorize("*"), assignMenuToRole);
...
router.get('/menu', auth, getMenuByRole);
